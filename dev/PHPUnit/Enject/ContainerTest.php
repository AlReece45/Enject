...
/*
 * @see Enject_Container
 */
class Test_Enject_ContainerTest
	extends Test_Enject_TestCase
{
	...
	function testInstance()
	{
		...
		$this->assertType('Enject_Container', $container);
	}
	...
	function testInjectInjection()
	{
		...
		$this->assertEquals($properties['test'], 'testValue');
	}
