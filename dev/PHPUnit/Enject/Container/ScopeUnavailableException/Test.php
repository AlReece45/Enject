 ...
 */
class Test_Enject_Container_ScopeUnavailableException_Test
	extends Test_Enject_TestCase
{
	...
	{
		$className = 'Enject_Container_ScopeUnavailableException';
		$this->assertClassExists($className);
		$container = new Enject_Container_ScopeUnavailableException('test');
