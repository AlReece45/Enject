 ...
 */
class Test_Enject_Container_TypeUnavailableException_Test
	extends Test_Enject_TestCase
{
	...
	{
		$className = 'Enject_Container_TypeUnavailableException';
		$this->assertClassExists($className);
		$container = new Enject_Container_TypeUnavailableException('test');
